...
//  }
  ...
  sift->detect( src_gray1_expanded, keypoints_1 );
  sift->detect( src_gray2_expanded, keypoints_2 );

  sift->compute(src_gray1_expanded, keypoints_1, IM1_descriptors);
  sift->compute(src_gray2_expanded, keypoints_2, IM2_descriptors);
